...
fun CustomDialog(
    ...
    val txtFieldMember = remember { mutableStateOf(reservation.player_number.toString()) }
                            ...
                            OutlinedTextField(
                                ...
                                placeholder = {
                                    if(txtFieldErrorMember.value!="") {
                                        ...
                                        Text(text =  stringResource(R.string.participants) )

                                    }
                                    },
                                label = { Text(text = stringResource(R.string.participants) )},
                                value = txtFieldMember.value,
                                keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Number),
                                onValueChange = {
                                    txtFieldMember.value = it
                                    ...
                                    if (it.toIntOrNull() != null) {
                                        courtSlotInfo.setPeople(Integer.parseInt(it))
                                        reservation.player_number = Integer.parseInt(it)
                                        newRes.player_number=Integer.parseInt(it)+1
                                        if(newRes.player_number>=(reservation.confirmed_participants.size-1)){
                                            txtFieldErrorMember.value = ""
